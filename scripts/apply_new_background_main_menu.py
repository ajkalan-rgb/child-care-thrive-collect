...
<LinearLayout android:id="@+id/child_care_menu_stack" android:layout_width="0dp" android:layout_height="0dp" android:orientation="vertical" android:weightSum="721" app:layout_constraintTop_toBottomOf="@id/menu_top" app:layout_constraintBottom_toTopOf="@id/menu_bottom" app:layout_constraintStart_toStartOf="parent" app:layout_constraintEnd_toEndOf="parent" app:layout_constraintWidth_percent="0.68">
{''.join(children)}
</LinearLayout>
...
print("Applied new_background_only.png with widened main-menu buttons")
